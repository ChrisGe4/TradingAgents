...
from tradingagents.backtest import backtest_trading_agents, BacktestingPipeline, \
  BacktestConfig
...
def example_comprehensive_analysis():
  ...
  if 'monte_carlo' in analysis:
    ...
    print(
      f"  95% Confidence:      ${mc.confidence_intervals[0.95][0]:,.2f} - ${mc.confidence_intervals[0.95][1]:,.2f}")
