...
class BaseStrategy(ABC):
  ...
  def initialize(self, tickers: List[str], start_date: datetime) -> None:
    ...
    logger.info(
      f"Strategy '{self.name}' initialized with {len(tickers)} tickers")
...
class PositionSizer:
  ...
  def calculate_position_size(
    ...
    if self.method == 'equal_weight':
      return self._equal_weight(portfolio_value, current_price,
                                max_position_size)
      ...
      return self._confidence_weighted(signal, portfolio_value, current_price,
                                       max_position_size)
  ...
  def _confidence_weighted(
    ...
    if max_position_size:
      weighted_allocation = min(weighted_allocation,
