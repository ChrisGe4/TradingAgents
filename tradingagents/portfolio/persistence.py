...
class PortfolioPersistence:
  ...
  def __init__(self, base_dir: Optional[str] = None):
    ...
    logger.info(
      f"Initialized PortfolioPersistence with base_dir={self.base_dir}")
  ...
  def _insert_positions(
    ...
    for ticker, position_data in positions.items():
      cursor.execute('''
          ...
          str(position_data.get('stop_loss')) if position_data.get(
            'stop_loss') else None,
          str(position_data.get('take_profit')) if position_data.get(
  ...
  def _insert_trades(
    ...
    for trade_data in trades:
      cursor.execute('''
          ...
          str(trade_data.get('exit_price')) if trade_data.get(
            'exit_price') else None,
          str(trade_data.get('quantity', '0')),
          str(trade_data.get('pnl')) if trade_data.get('pnl') else None,
          str(trade_data.get('pnl_percent')) if trade_data.get(
            'pnl_percent') else None,
